...
namespace NeXenAdminPortal.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientName,NumberOfUsers,SpecialOffer")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ClientName,NumberOfUsers,SpecialOffer")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
